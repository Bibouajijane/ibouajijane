...
class Staff extends CI_Controller {
    ...
    public function insert()
    {
        ...
        $this->form_validation->set_rules('slcdepartment', 'Groupe', 'required');
        ...
        $this->form_validation->set_rules('txtcity', 'CIN', 'required');
        $this->form_validation->set_rules('txtstate', 'Formation', 'required');
        $this->form_validation->set_rules('txtaddress', 'Avance', 'required');
        $this->form_validation->set_rules('slccountry', 'Mode', 'required');
        ...
        if($this->form_validation->run() !== false)
        {
            ...
            if($data==true)
            {
                ...
                $this->session->set_flashdata('success', "New Student Added Succesfully"); 
            }else{
                $this->session->set_flashdata('error', "Sorry, New Student Adding Failed.");
            }
    ...
    public function update()
    {
        ...
        if($this->form_validation->run() !== false)
        {
            ...
            {
                $this->session->set_flashdata('success', "Student Updated Succesfully"); 
            }else{
                $this->session->set_flashdata('error', "Sorry, Student Updated Failed.");
            }
    ...
    function delete($id)
    {
        ...
        if($this->db->affected_rows() > 0)
        {
            ...
            $this->session->set_flashdata('error', "Sorry, Student Delete Failed.");
        }
        redirect($_SERVER['HTTP_REFERER']);
    }
