...
class Department extends CI_Controller {
    ...
    public function insert()
    {
        ...
        if($data==true)
        {
            $this->session->set_flashdata('success', "New Groupe Added Succesfully"); 
        }else{
            $this->session->set_flashdata('error', "Sorry, New Groupe Adding Failed.");
        }
    ...
    public function update()
    {
        ...
        {
            $this->session->set_flashdata('success', "Groupe Updated Succesfully"); 
        }else{
            $this->session->set_flashdata('error', "Sorry, Groupe Update Failed.");
        }
    ...
    function delete($id)
    {
        ...
        if($this->db->affected_rows() > 0)
        {
            $this->session->set_flashdata('success', "Groupe Deleted Succesfully"); 
        }else{
            $this->session->set_flashdata('error', "Sorry, Groupe Delete Failed.");
        }
        redirect($_SERVER['HTTP_REFERER']);
    }
