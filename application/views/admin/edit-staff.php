                  ...
                  <?php echo form_open_multipart('Staff/update');?>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>CIN</label>
                          <input type="text" name="txtcity" value="<?php echo $cnt['city'] ?>" class="form-control" placeholder="CIN"  readonly>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="txtstate" value="<?php echo $cnt['state'] ?>" class="form-control" placeholder="Formation">
                        </div>
                      </div>
